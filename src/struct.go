...
var Commands = []CommandStruct{
	...
	{true, "удалить данные из таблицы <b>teams</b> или <b>codes</b>", "reset", []string{"admin"}},
	{true, "добавить новые правильные коды в формате: <b>Code,Danger,Sector,TimeBonus,Tasks</b>", "add", []string{"admin"}},
	{true, "обновить коды в бд, в формате: <b>CodeNew,Danger,Sector,TimeBonus,TaskID,CodeOld</b>", "update", []string{"admin"}},
	{true, "удалить указанный код", "delete", []string{"admin"}},
	{true, "список всех команд", "listteams", []string{"admin"}},
	{true, "создать таблицы в БД", "createdb", []string{"admin"}},
}
