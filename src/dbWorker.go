...
func (confDataBase *Teams) DBCreateTeam() string {
	...
	_, err = db.Exec("INSERT INTO Teams (Time, Team,  Hash, NickName) VALUES ($1, $2, $3, $4)",
		confDataBase.Time, confDataBase.Team, confDataBase.Hash, confDataBase.NickName)
	if err != nil {
		log.Println(err)
		return err.Error()
	}
...
func (confDataBase *Teams) DBSelectTeam() []Teams {
	...
	rows, err := db.Query("SELECT ID, Time, Team, Hash, NickName FROM Teams")
	if err != nil {
...
func (confDataBase *Users) DBInsertUser() string {
	...
	return fmt.Sprintf("&#10004;Игрок %s <b>добавлен</b> в команду %s.", confDataBase.NickName, confDataBase.Team)
}
